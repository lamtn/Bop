package masysdio.masplayerpre.Handlers;
...
import masysdio.masplayerpre.Activities.MainScreen;
import masysdio.masplayerpre.BopUtils.ExtraUtils;
import masysdio.masplayerpre.R;
import masysdio.masplayerpre.services.ServicePlayMusic;
...
public class NotificationHandler extends BroadcastReceiver {
    public static final String ACTION_PAUSE = "masysdio.masplayer.pause";
    public static final String ACTION_PLAY = "masysdio.masplayer.play";
    public static final String ACTION_PREV = "masysdio.masplayer.prev";
    public static final String ACTION_NEXT = "masysdio.masplayer.next";
    public static final String ACTION_STOP = "masysdio.masplayer.stop";
    private static final String CHANNEL_ID = "masysdio.masplayer.MUSIC_CHANNEL_ID";
