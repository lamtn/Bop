package masysdio.masplayerpre.BopUtils;
...
public class RecentUtils {
    ...
    public static void addsong_toRecent(Context context, Song song) {
        ...
        SharedPreferences appSharedPrefs = context.getSharedPreferences("masysdio.masplayer.RecentSongs", Context.MODE_PRIVATE);
    ...
    public static void addcountSongsPlayed(Context context, Song song) {
        SharedPreferences preferences = context.getSharedPreferences("masysdio.masplayer.SongsPlayedCount", Context.MODE_PRIVATE);
    ...
    public static void saveLastPlaylist(Context context, ArrayList<Song> theSongs) {
        SharedPreferences appSharedPrefs = context.getSharedPreferences("masysdio.masplayer.LastPlaylist", Context.MODE_PRIVATE);
        SharedPreferences.Editor prefsEditor = appSharedPrefs.edit();
