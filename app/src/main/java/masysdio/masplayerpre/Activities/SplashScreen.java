...
import masysdio.masplayerpre.Handlers.PermissionHandler;
...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences recent = getSharedPreferences("masysdio.masplayer.RecentSongs", 0);
        SharedPreferences count = getSharedPreferences("masysdio.masplayer.SongsPlayedCount", 0);
        SharedPreferences last = getSharedPreferences("masysdio.masplayer.LastPlaylist", 0);
